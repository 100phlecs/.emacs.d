...
* In retrospect
I tried out Emacs out of hype only to shortly give up after. Time went
on, and slowly I found other tools lacking.
...
It would've took some time to read it all of course, which is why I
didn't do it at the beginning. Who would want to spend an evening
reading through a four decade old text-editor manual? So I used Google
to look for shortcuts, which usually worked and saved time... but not
this time. Google doesn't bake in concepts and keybindings. Only
effort and patience does.
